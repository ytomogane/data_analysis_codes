...
# データの読み込み
rocdata <- read.xlsx("C:/Users/yousu/Google_Drive/for_analyze_09282018_ABOD_for_DrOISHIdata/Bonferroni_results09282018.xlsx",
                     #                     sheet=1)
...
{  
  ...
  plot(perf,main=sprintf("Bonferroni LV%01dROCcurve",J))
  abline(a=0,b=1,lty=2 )
  dev.off()
  ...
  file.name=sprintf("Bonferroni LV%01dROC.csv",J)
  ...
  threshold1(ROCK, rocdata$forROC)
  threshold2(ROCK, rocdata$forROC)
  file.name=sprintf("Bonferroni LV%01dthreshhold.csv",J)
